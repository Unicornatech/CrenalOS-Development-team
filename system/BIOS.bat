...
Title BIOS
cls
Echo system is locked enter CMOS password
set /p Choice=Password
if %Choice% == CMOS goto Approve
goto lock
...
IF EXIST "bootsector.dll" (goto HEAD
...
cls
title desktop
echo *** hello! %User%***************************************************************************************************************************************its %DATE% the time is %TIME% *******
